            ...
            headerRight: () => {
              return (
                <TouchableOpacity style={{
                  ...
                  onPress={() => {
                    Alert.alert('Delete all', 'You are about to delete all saved articles',
                    [
                      {
                      text: "Cancel",
                ...
                >
                  <MaterialCommunityIcons name="trash-can-outline" size={30} color={isDarkMode ? "#fff" : "#000"} />
                </TouchableOpacity>
              )
            }
          }}
    ...
    <Tab.Navigator>
      ...
      <Tab.Screen
          ...
          options={{
            tabBarLabel: 'Saved',
            tabBarIcon: ({ color }) => (
              <MaterialCommunityIcons name="file-cabinet" color={color} size={26} />
            ),
          }}
      />
    </Tab.Navigator>
